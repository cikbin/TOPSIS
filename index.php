    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image--><img class="masthead-avatar mb-5" src="assets/img/beans.png" alt="" /><!-- Masthead Heading-->
                <h1 class="masthead-subheading text-uppercase mb-0">Sistem Pendukung Keputusan Metode TOPSIS</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Pemilihan Jenis Biji Kopi Terbaik</p>
            </div>
        </header>

        <!-- Copyright Section-->
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Bina Estherly-4611417026</small></div>
        </div>
